...
namespace TeamHost.Presentation.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(UserManager<AppUser> userManager, ITokenService tokenService, IWebHostEnvironment env)
        {
        ...
        public async Task<IActionResult> Login([FromForm]LoginModel model)
        {
            ...
            var token = _tokenService.GenerateToken(usr, nameof(UserRole.User));
        ...
        public async Task<IActionResult> Register([FromForm]RegisterModel dto)
        {
            ...
            var roleRes = await _userManager.AddToRoleAsync(usr, nameof(RoleTypes.User));
